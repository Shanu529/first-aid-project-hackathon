...
//           <h2 className="text-xl font-semibold mb-4 text-left">Nearest Hospitals</h2>
...
//                   className="mt-3 sm:mt-0 inline-flex items-center gap-2 bg-blue-600 text-white px-3 py-2 rounded-lg text-sm hover:bg-blue-700 transition"
//                 >
...
//           No hospitals to show yet. Click the button above to find nearby hospitals.
//         </div>
//       )}
//     </div>
//   );
